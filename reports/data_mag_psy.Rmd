...
```{r data, cache.lazy=F}
d_raw = read_csv("~/choosing_to_grow/data_academic/processed/mag_psy.txt", col_types='cccddccc')
...
We start with some exploratory plots.
