...
fs <- list(
  ...
  mlogit(y ~ censored_log(deg, min=1) + has_deg + recip + safe_log(n_paths) | 0, H_train)
)
```
...
DF <- rbind(
  ...
  data.frame(deg=1:100  , est=coef(f4)[1:100] , se=coef(summary(f4))[1:100,2] , model='4'),
...
write_csv(DF2, "../results/fig6_flickr2.csv")
```
