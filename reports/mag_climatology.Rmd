...
a <- make_data(n=3000, seed=133)
b <- make_data(n=3000, seed=549)
c <- rbind(a, b[!(b$paper_id %in% a$paper_id), ])
H_train <- c %>%
  filter(paper_id %in% distinct(c, paper_id) %>% sample_n(5000) %>% .$paper_id) %>%
